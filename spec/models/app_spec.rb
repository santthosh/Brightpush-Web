...
describe App do
  ...
  before(:each) do
    @app = apps(:app_1)
    ApplicationController.stubs(:initialize_bucket_name)
  end
  ...
  #  @application = App.create(:name => 'application_three', :key => 'key_three', :development_push_certificate_file => File.new(Rails.root + 'spec/fixtures/certificate/DevelopmentPush.p12'), :development_push_certificate => File.new(Rails.root + 'spec/fixtures/certificate/DevelopmentPush.p12'), :crypted_development_push_certificate_password => 'tamil4g@123', :crypted_production_push_certificate_password => 'tamil4g@123')
