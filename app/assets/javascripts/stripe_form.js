(function($){
  ...
  $(document).ready(function() {
    $("#creditcard_new").submit(function(event) {
      if ($('#paypal').is(':checked')) {
        // Clear credit card values and allow normal submit
    ...
    $("#creditcard_new input[name=commit]").removeAttr('disabled');
  });
})(jQuery);
